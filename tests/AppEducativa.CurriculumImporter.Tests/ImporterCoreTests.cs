...
namespace AppEducativa.CurriculumImporter.Tests;
...
public class ImporterCoreTests
{
    ...
    public async Task PdfExtractor_ExtractsSyntheticPdfPage()
    {
        ...
        var result = await extractor.ExtractAsync(Source(), new AppEducativa.CurriculumImporter.Models.Download.DownloadedSource { LocalFilePath = path });
