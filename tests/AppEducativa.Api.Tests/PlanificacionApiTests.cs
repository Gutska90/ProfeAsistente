...
public class PlanificacionApiTests : IDisposable
{
    ...
    public PlanificacionApiTests()
    {
        ...
        _planes = new PlanificacionService(_db, planRepo, new AppEducativa.Api.Tests.TestDoubles.FakeCurrentUserService(), new AppEducativa.Api.Tests.TestDoubles.AllowAllResourceAuthorizationService());
