...
using ExtractedDocument = ProfeAsistente.CurriculumImporter.Models.Extraction.CurriculumExtractionResult;

namespace ProfeAsistente.CurriculumImporter.Services.Parsing;
...
{
    public static ProfeAsistente.Shared.Dtos.CurriculumExtractionResult ToSharedDto(
        this ExtractedCurriculumPackage package, CurriculumSourceDefinition source)
    {
        return new ProfeAsistente.Shared.Dtos.CurriculumExtractionResult
        {
