...
public class ProfeAsistenteDbContext : IdentityDbContext<ApplicationUser, ApplicationRoleEntity, Guid>
{
    public ProfeAsistenteDbContext(DbContextOptions<ProfeAsistenteDbContext> options) : base(options) { }
