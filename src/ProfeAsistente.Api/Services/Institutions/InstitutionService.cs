...
namespace ProfeAsistente.Api.Services.Institutions;
...
public sealed class InstitutionService : IInstitutionService
{
    ...
    public InstitutionService(ProfeAsistenteDbContext db, ICurrentUserService current, IAuditService audit)
    {
        _db = db;
        _current = current;
        _audit = audit;
