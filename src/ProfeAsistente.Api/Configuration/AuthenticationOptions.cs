...
public sealed class AuthenticationOptions
{
    ...
    public string Issuer { get; set; } = "ProfeAsistente.Api";
    public string Audience { get; set; } = "ProfeAsistente.Maui";
    public int AccessTokenMinutes { get; set; } = 30;
    public int RefreshTokenDays { get; set; } = 7;
    public bool RequireConfirmedEmail { get; set; }
    public int MaximumFailedAttempts { get; set; } = 5;
    public int LockoutMinutes { get; set; } = 15;
    /// <summary>Solo Development: permite iniciar sin PROFEASISTENTE_JWT_KEY usando una clave efímera.</summary>
