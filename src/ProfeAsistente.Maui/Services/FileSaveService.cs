...
/// <summary>
/// Guarda en Documents/ProfeAsistente. En Windows/macOS el usuario puede mover el archivo después.
...
public sealed class FileSaveService : IFileSaveService
{
    ...
    {
        var folder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "ProfeAsistente");
