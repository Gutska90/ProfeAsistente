...
using NewDownloadedSource = AppEducativa.CurriculumImporter.Models.Download.DownloadedSource;
using NewSourceDownloader = AppEducativa.CurriculumImporter.Services.Download.ISourceDownloader;
using AppEducativa.CurriculumImporter.Services.Download;
using AppEducativa.Shared.Dtos;
using Microsoft.Extensions.Logging;

namespace AppEducativa.CurriculumImporter.Download;
...
public class HttpSourceDownloader : AppEducativa.CurriculumImporter.Abstractions.ISourceDownloader, NewSourceDownloader
{
