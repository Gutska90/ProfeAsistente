...
using LegacyDownloader = AppEducativa.CurriculumImporter.Abstractions.ISourceDownloader;
using NewDownloaded = AppEducativa.CurriculumImporter.Models.Download.DownloadedSource;
using NewDownloader = AppEducativa.CurriculumImporter.Services.Download.ISourceDownloader;
using SharedDownloaded = AppEducativa.Shared.Dtos.DownloadedSource;
using SharedExtraction = AppEducativa.Shared.Dtos.CurriculumExtractionResult;
using ICurriculumDiffService = AppEducativa.CurriculumImporter.Abstractions.ICurriculumDiffService;
using ICurriculumImportService = AppEducativa.CurriculumImporter.Abstractions.ICurriculumImportService;
using ICurriculumValidator = AppEducativa.CurriculumImporter.Abstractions.ICurriculumValidator;
...
public sealed class OfficialCurriculumImportOrchestrator
{
    ...
    private readonly AppEducativa.CurriculumImporter.Services.Extraction.ICurriculumExtractor _pdfExtractor;
    ...
    public OfficialCurriculumImportOrchestrator(
        ...
        AppEducativa.CurriculumImporter.Services.Extraction.ICurriculumExtractor pdfExtractor,
    ...
    private string ResolveSourcesPath()
    {
        ...
        var candidates = new[]
        {
            ...
            Path.GetFullPath(Path.Combine(_environment.ContentRootPath, "..", "AppEducativa.CurriculumImporter", "Configuration", "curriculum-sources.json"))
        };
